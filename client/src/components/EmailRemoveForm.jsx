...
const EmailRemoveForm = () => {
	...
	const handleSubmit = async (e) => {
		...
		if (!name.trim() || !mail.trim() || !category.trim()) {
			toast.error(
				"Please provide a category and either a description or a file"
			);
			return;
		}
		...
		try {
			...
			await removeEmail(category.trim(), formData);
			// Clear form
			setMail("");
			setCategory("");
			setName("");
...
export default EmailRemoveForm;
